...
public class CoinChangeTest {
	...
	public void nullCoins() {
		new CoinChange().coinChange(null, 0);
	}

	@Test
	public void emptyCoins() {
		new CoinChange().coinChange(new int[] {}, 0);
	}

	@Test
	public void fNegative() {
		new CoinChange().coinChange(new int[] { 1, 2, 5 }, -1);
	}

	@Test
	public void f0() {
		new CoinChange().coinChange(new int[] { 1, 2, 5 }, 0);
	}

	@Test
	public void f1() {
		new CoinChange().coinChange(new int[] { 1 }, 1);
	}

	@Test
	public void f11() {
		Assert.assertSame(3, new CoinChange().coinChange(new int[] { 1, 2, 5 }, 11));
	}
	...
	public void f_Extreme() {
		Assert.assertSame(2, new CoinChange().coinChange(new int[] { 1, 2147483647 }, 2));
	}
}
